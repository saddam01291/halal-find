...
export function HalalBadge({ status = 'unverified', hasActiveReports, reviewCount, className, showText = true }: HalalBadgeProps) {
    const configs = {
        owner_verified: {
            icon: ShieldCheck,
            text: 'Owner Verified',
        ...
        reported: {
            ...
            color: 'text-white bg-red-600 border-red-500 shadow-red-100',
